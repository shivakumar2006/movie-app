...
const Authentication = () => {
  ...
  return (
    ...
    >
        ...
        <h1 className='text-sm font-light mt-2'>Movie Recommendation App</h1>
      {/* <h1 className='text-5xl font-extrabold text-blue-900 md:text-5xl mb-0'>Flick Frenzy</h1> */}
      <div className='w-80 sm:w-96 md:w-120 lg:w-150 h-120 bg-white/8 rounded-2xl flex flex-col justify-center items-center shadow-sm hover:shadow-xl gap-8'>
