...
import { useGetAiringTodayTvShowsQuery, useGetFilteredTvShowQuery, useGetPopularMoviesPagesQuery } from '../app/apiSLice';
...
const AiringToday = () => {
    ...
    const { data: filteredData, isLoading: filteredLoading } = useGetAiringTodayTvShowsQuery({
        language,
        minRating,
        sortBy,
        page
    ...
    return (
        <div className='w-screen min-h-screen flex flex-col'>
            <div className='w-full mt-10'>
                <h1 className='text-2xl mx-15'>Airing Today</h1>
            </div>
