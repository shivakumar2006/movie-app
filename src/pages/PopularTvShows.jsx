...
import { useGetPopularTvShowsQuery } from '../app/apiSLice';

const PopularTvShows = () => {

     const [ page, setPage ] = useState(1);
        const { data, error, isLoading } = useGetPopularTvShowsQuery(page);
                    ...
                    <div className='w-[1040px] flex flex-col justify-center'>
                        <div className='flex flex-wrap justify-evenly gap-5'>
                            {data?.results?.map((show) => (
                                <div key={show.id} className='w-50 h-100 rounded-2xl shadow-xl overflow-hidden hover:scale-105 transition-all transform duration-300 ease-in-out'>
                                    ...
                                    <div className="text-center mt-3 text-xl font-medium px-1">
                                        ...
                                        <p className='text-sm font-light'>{show.first_air_date}</p>
                                    </div>
