...
import { useGetFilteredMoviesQuery, useGetFilteredNowPlayingMovieQuery, useGetPopularMoviesPagesQuery, useGetUpcomingMoviesQuery } from '../app/apiSLice';
...
const Upcoming = () => {
    ...
    const { data: filteredData, isLoading: filteredLoading } = useGetUpcomingMoviesQuery({
        language,
        minRating,
        sortBy,
        page
    ...
    return (
        <div className='w-screen min-h-screen flex flex-col'>
            <div className='w-full mt-10'>
                <h1 className='text-2xl mx-15'>UpComing</h1>
            </div>
